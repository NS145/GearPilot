...
export const trayAPI = {
  ...
  suggestNumber: (rackId) => api.get(`/tray/next-number/${rackId}`),
  create: (data) => api.post('/tray', data),
  bulkCreate: (data) => api.post('/tray/bulk', data),
